...
名前: 加賀谷諒(かがやりょう)  
生年月日: 1995/4/26  
[自己紹介](https://rkaga.super.site), [Blog](https://r-kaga.com/), [X](https://twitter.com/ry0_kaga), [Zenn](https://zenn.dev/r_kaga), [Github](https://github.com/r-kaga), [Speaker Deck](https://speakerdeck.com/rkaga)  
...
- 会計情報取り込み機能のリファクタリング
  ...
  - プロセス
    ...
    - 本機能で障害を発生すると後続の全ての業務に影響を受けるため、可能な限り影響を低減するのを最優先にPJを進行する事を意思決定
      - オンコール対応履歴や利用履歴などから最も利用率が高い会計システムを優先して調査・ドキュメント化
      - リファクタ後のコード設計は最も複雑度が高い会計システム・パターンを念頭に設計
      - リリースに関しては、利用頻度や複雑度を鑑みて最も難易度・影響が低いと判断した会計システムから実施 
