...
生成AI/LLMチームでは、リードソフトウェアエンジニアとしてデザイン・開発まで横断的に推進。LLMを用いた機能開発や業務改善ツールの開発を複数行う。  
...
現在は生成AI/LLMチームの立ち上げを行なう。主にUI/UXデザイン・開発領域をソフトウェアエンジニアとしてLLMを用いた機能開発や業務改善ツールの開発を複数行っている。  

#### 主な担当案件
- プロダクト
  - 会計情報取り込み機能のリファクタリングのエピックオーナー
  - [自然言語レポート作成補助機能（α版）](https://prtimes.jp/main/html/rd/p/000000073.000052025.html)のリードエンジニア
  - [AI分析アシスタント（β版）](https://prtimes.jp/main/html/rd/p/000000094.000052025.html)のリードエンジニア
- 業務改善
